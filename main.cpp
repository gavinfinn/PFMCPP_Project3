...
5 properties:
    1) wing loading
    2) lift to drag ration
    3) type/shape of wing
    4) altitude
    5) length
3 things it can do:
    1) engage flaps
...
5 properties:
    ...
    4) overhead storage bin capacity
    5) seat numbers
3 things it can do:
...
Thing 9) Storage
5 properties:
    1) max weight allowed
    2) width of storage area
    3) length of storage area
    4) height of storage area
    5) number of stored luggage
3 things it can do:
